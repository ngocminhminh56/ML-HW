...
class ParabolLinearRegression:
    ...
    def plot(self, save_path):
        ...
        plt.plot(self.x, y_pred, color='green', linewidth=2)
...
def main():
    x, y = load_dataset(file_path="D:\ML-DSEB62\HW4\Problem1\data_square.csv")
    model = ParabolLinearRegression(x, y)
    theta = model.fit()
    print(f'Estimated coefficient for linear model is\n theta = {theta}')
    model.plot(save_path='D:\ML-DSEB62\Problem 1.png')
