...
def main():
    x, y = load_dataset(file_path=r"D:\DSEB LEARNINGB MATERIAL\ML 1\Machine-Learning-1-DSEB62\Week 3\data_linear.csv")
    model_1 = LinearRegression()
    theta = model_1.fit(x, y)
    print(f'Estimated coefficient for linear model is\n w0 = {theta[0]} \nw1 = {theta[1]}')
    plot(x, y, theta, save_path="D:\DSEB LEARNINGB MATERIAL\ML 1\Machine-Learning-1-DSEB62\Week 3\Problem2.png")
    for i in [50, 100, 150]:
