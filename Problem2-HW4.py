...
class PolynomialLinearRegression:
    ...
    def plot(self, save_path):
        ...
        plt.plot(x_line, y_predict, color='blue', linewidth=2, label='Prediction')
...
def main():
    ...
    for order in [0, 3, 6, 9]:
        ...
        model.plot(save_path=f"D:\ML-DSEB62\Problem 2 part a model order {order}.png")
    ...
    model1.plot(save_path=f"D:\ML-DSEB62\Problem 2 part b small.png")
    model2.plot(save_path=f"D:\ML-DSEB62\Problem 2 part b large.png")
    ...
    model.plot(
        save_path=f"D:\ML-DSEB62\Problem 2 Ridge Regression.png")
    ...
    model.plot(save_path=f"D:\ML-DSEB62\Problem 2 Lasso Regression.png")
