...
def main():
    x, y = load_dataset(file_path=r"D:\DSEB LEARNINGB MATERIAL\ML 1\Machine-Learning-1-DSEB62\Week 3\housing.csv")
    model_1 = LinearRegression2()
    theta = model_1.fit(x, y, learning_rate=0.5)
    print(theta)
    plot(x, y, theta, save_path="D:\DSEB LEARNINGB MATERIAL\ML 1\Machine-Learning-1-DSEB62\Week 3\Problem3.png")
